...
<section id="mu-slider">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="{{asset('public/fontend/assets/img/slider/1.jpg')}}" alt="img">
        </figure>
      </div>
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="{{asset('public/fontend/assets/img/slider/2.jpg')}}" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="{{asset('public/fontend/assets/img/slider/3.jpg')}}" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
